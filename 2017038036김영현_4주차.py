...
while 0 < num < 5:
    ...
    if num == 1:
        ...
        DelW = int(input("삭제할 학생의 학번을 입력하시오 : "))
        DelW2 = input("삭제할 학생의 이름을 입력하시오 : ")
        if DelW == students[0]["id"] and DelW2 == students[0]["name"]:
            del students[0]
        elif DelW == students[1]["id"] and DelW2 == students[1]["name"]:
            del students[1]
        elif DelW == students[2]["id"] and DelW2 == students[2]["name"]:
            del students[2]
        elif DelW == students[3]["id"] and DelW2 == students[3]["name"]:
            del students[3]
        elif DelW == students[4]["id"] and DelW2 == students[4]["name"]:
            del students[4]
    elif num == 4:
